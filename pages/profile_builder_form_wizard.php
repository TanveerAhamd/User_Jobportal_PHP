...
<hr>
                                        ...
                                        <div id="experience" class="data-section">
                                            ...
                                            <div class="col-md-12 table-responsive">
                                                <table class="table table-hover table-striped bg-secondary-subtle"
                                                    id="work_history_table">
                                                    <thead style="background-color:#000;">
                                                        <tr>
                                                            ...
                                                            <th scope="col" class="bg-secondary-subtle py-3"> Company
                                                                Name</th>
                                                            <th scope="col" class="bg-secondary-subtle py-3">Job Level
                                                            </th>
                                                            <th scope="col" class="bg-secondary-subtle py-3">
